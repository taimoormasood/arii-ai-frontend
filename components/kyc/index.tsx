...
import { alertSuccess, Logo } from "@/assets/images";
...
export function KycComponent() {
  ...
  return (
    <div className="space-y-8  shadow-sm h-fit border border-gray-200  rounded-lg bg-white">
      <div className="w-full bg-white p-6 rounded-md">
        ...
        <h1 className="text-2xl font-bold text-gray-900 mb-2 xl:mb-8 text-center">
          Verify KYC
        </h1>
