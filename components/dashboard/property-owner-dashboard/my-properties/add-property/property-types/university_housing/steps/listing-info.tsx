...
const ListingInfo = () => {
  ...
  useEffect(() => {
    if (apiListingDetails && propertyId) {
      ...
      const listingStoreData = {
        ...
        occupancyType: apiListingDetails.occupancy_type || "",
      ...
      form.reset({
        ...
        occupancyType: listingStoreData.occupancyType as any,
      ...
      if (!hasExistingListingData) {
        form.reset({
          ...
          totalRooms: listingDetailsData.totalRooms
            ...
            : 0,
          occupancyType: listingDetailsData.occupancyType as any,
  ...
  const onSubmit = async (isSaveExit: boolean, data: FormValues) => {
    ...
    const payload: any = {
      ...
      number_of_units: data.totalRooms,
    ...
    const mutationOptions = {
      onSuccess: (response: any) => {
        ...
        const updatedStoreData = {
          ...
          occupancyType: data.occupancyType as any,
          description: data.description,
                ...
                <FormControl>
                  <div className="space-y-3 w-full flex flex-col items-start sm:items-center shadow-md rounded-lg border border-gray-200 p-4">
                    ...
                    {form.formState.errors.availability?.message && (
                      <p className="text-red-500 text-sm mt-1 text-left mr-auto">
                        {form.formState.errors.availability.message}
                      </p>
                    )}
                  </div>
