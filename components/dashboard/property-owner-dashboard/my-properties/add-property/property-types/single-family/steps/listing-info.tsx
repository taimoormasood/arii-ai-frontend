...
const ListingInfo = () => {
  ...
  const hasExistingListingData =
    ...
    (apiListingDetails.listed_by ||
      apiListingDetails.total_bedrooms ||
      apiListingDetails.total_bathrooms ||
  ...
  useEffect(() => {
    if (apiListingDetails && propertyId) {
      ...
      const listingStoreData = {
        ...
        totalBedrooms: apiListingDetails.total_bedrooms
          ? String(apiListingDetails.total_bedrooms)
          : "0",
        totalBathrooms: apiListingDetails.total_bathrooms
          ? String(apiListingDetails.total_bathrooms)
          : "0",
        squareFootage: apiListingDetails.square_footage
          ? String(apiListingDetails.square_footage)
          : "",
      ...
      form.reset({
        ...
        totalBedrooms: Number(listingStoreData.totalBedrooms),
        totalBathrooms: Number(listingStoreData.totalBathrooms),
        squareFootage: listingStoreData.squareFootage,
  ...
  }, [apiListingDetails, propertyId, form, updateStepData]);
