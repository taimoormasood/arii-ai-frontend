...
import AvailabilityCalendar from "../property-types/common/availability-calendar";
import { baseRentalDetailSchema, createRentalDetailSchema } from "./schema";
...
const RentDetails = ({
  ...
  useEffect(() => {
    if (apiRentalDetails && propertyId) {
      ...
      const apiRentalType = apiRentalDetails.rental_type || "short_term";
      ...
      const rentalStoreData = {
        property: propertyId,
        rentalType: apiRentalType as "short_term" | "long_term",
      ...
      setRentalType(apiRentalType as "short_term" | "long_term");
      ...
      methods.reset({
        ...
        assignedTenant: matchedTenantValue || "",
        dailyRent:
          apiRentalType === "short_term"
            ? apiRentalDetails.rent
              ? Number(apiRentalDetails.rent)
              : 0
            : 0,
        monthlyRent:
          apiRentalType === "long_term"
            ? apiRentalDetails.rent
              ? Number(apiRentalDetails.rent)
              : 0
            : 0,
  ...
  const showAvailabilityCalendar = rentalType === "short_term";
          ...
          <FormProvider {...methods}>
            ...
            >
              <CustomInput
                ...
                select
                onChange={(value) => {
                  setValue("rentalType", value as "short_term" | "long_term");
                  setRentalType(value as "short_term" | "long_term");
                  // Clear validation errors when switching rental type
                  clearErrors("dailyRent");
