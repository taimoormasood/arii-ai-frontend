...
const UnitAvailabilityViewDetail: React.FC<{
  heading?: string;
  ...
  const renderCalendarDays = () => {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      ...
      let cellClasses = `h-24 w-full w-16 flex pl-2 pr-2 items-start justify-start text-sm ${
      ...
      if (isPast && isUnavailable) {
        ...
        numberClasses += " font-medium text-white";
      }
...
export default UnitAvailabilityViewDetail;
